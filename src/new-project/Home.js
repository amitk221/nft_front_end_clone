          ...
          <div className='row'>
            <div className='col-1'></div>
              <div className='col-5' style={{marginTop:"2rem", fontSize:"2rem", marginBottom:"3rem"}}>
                <button type="button" class="btn btn-warning" style={{boxShadow: "#fcbc45" , fontSize:"1.4rem", borderRadius:"0.5rem"}}>Explore</button>
                <button type="button" class="btn btn-warning" style={{color:"white", marginLeft:"1rem", fontSize:"1.3rem", background:"none", borderRadius:"0.5", boxShadow:"2px solid fcbc45" }}>Create</button>
              </div>
              <div className='col-6'> 
